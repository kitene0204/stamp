...
export const STANDARD_PAD_PRESETS: StandardPadPreset[] = [
  ...
  },
  {
    ...
    heightMm: 70,
    category: '원형 (Circular)',
    description: '특대형 표창/기념 원형 도장',
  },
  {
    id: 'circle-80',
    name: '80mm 초대형 원형 (최대 규격)',
    shape: 'circle',
    widthMm: 80,
    heightMm: 80,
    category: '원형 (Circular)',
    description: '지원 최대 초대형 80mm 원형 패드',
  },
  {
    id: 'rect-10-10',
    name: '10 x 10mm 정사각',
  ...
  {
    id: 'rect-40-60',
    name: '40 x 60mm 대형 직사각',
    shape: 'rectangle',
    widthMm: 60,
    heightMm: 40,
    category: '사각 (Rectangular)',
    description: '알림장 서식 / 대형 공지 스탬프',
  },
  {
    id: 'rect-50-70',
    name: '50 x 70mm 특대형 직사각',
    shape: 'rectangle',
    widthMm: 70,
    heightMm: 50,
    category: '사각 (Rectangular)',
    description: '특대형 표 양식 및 체크리스트 도장',
  },
  {
    id: 'rect-50-80',
    name: '50 x 80mm 초대형 직사각',
    shape: 'rectangle',
    widthMm: 80,
    heightMm: 50,
    category: '사각 (Rectangular)',
    description: '대형 과제 검사 및 서명 양식 도장',
  },
  {
    id: 'rect-80-80',
    name: '80 x 80mm 초대형 정사각 (최대 규격)',
    shape: 'rectangle',
    widthMm: 80,
    heightMm: 80,
    category: '사각 (Rectangular)',
    description: '지원 최대 초대형 80x80mm 정사각 패드',
  },
];
