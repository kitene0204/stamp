...
export const A4PreviewCanvas: React.FC<A4PreviewCanvasProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-slate-900/5 rounded-2xl border border-slate-200/80 overflow-hidden shadow-inner">
      {/* Top Toolbar */}
      <div className="bg-white px-4 py-2.5 border-b border-slate-200 flex flex-wrap items-center justify-between gap-2 z-10">
        {/* Page Switcher */}
        <div className="flex items-center space-x-2">
          ...
          <span className="hidden sm:inline-block text-[11px] px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 font-medium">
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 text-xs">
          ...
          <div className="flex items-center space-x-1 bg-slate-100 rounded-lg p-0.5">
            ...
            <span className="text-xs font-mono px-1 font-semibold text-slate-700 min-w-[40px] text-center">
